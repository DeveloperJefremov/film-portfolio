...
export default function HomePhotoSection() {
	// Создаём плагины
	const plugin1 = Autoplay({ delay: 12000, stopOnInteraction: false });
	const plugin2 = Autoplay({ delay: 12000, stopOnInteraction: false });
	const plugin3 = Autoplay({ delay: 12000, stopOnInteraction: false });
	const plugin4 = Autoplay({ delay: 12000, stopOnInteraction: false });
